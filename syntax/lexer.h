...
public:
   ...
   */
  const static inline bool is_unicode_char(uint32_t code_point) {
   ...
   */
  const static inline bool is_unicode_digit(uint32_t code_point) {
   ...
   */
  const static inline bool is_unicode_punc(uint32_t code_point) {
